...
//		Uri mSoundFileUri = getOutputMediaFileUri(MEDIA_TYPE_AUDIO);
	...
	private void launchCameraIntent() {
		...
		Uri mCameraUri = getOutputMediaFileUri(MEDIA_TYPE_IMAGE);
		fragment.imagePath = mCameraUri;
		
		// TODO - Add the filename to the Intent as an extra. Use the Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		imageCaptureIntent.putExtra(MediaStore.EXTRA_OUTPUT, mCameraUri);
	...
	private void launchVideoCameraIntent() {
		...
		Uri mVideoUri = getOutputMediaFileUri(MEDIA_TYPE_VIDEO);
		
		// TODO - Add the filename to the Intent as an extra. Use the Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		videoCaptureIntent.putExtra(MediaStore.EXTRA_OUTPUT, mVideoUri);
		...
		startActivityForResult(videoCaptureIntent, CAMERA_VIDEO_REQUEST);
